...
<table width="476" align="center" cellspacing="1" bgcolor="#000000">
	...
	<tr bgcolor="#FFFFCC">
		...
		<td width="136"><input type="text" name="tgl_awal" id="tgl_awal" size="10" class="required" title="Harap Mengisi Tanggal Awal Dahulu" value="01-01-2017" />
	...
	<tr  bgcolor="#FFFFCC">
		<td colspan="5" align="center"><input type="submit" name="pdf" value="Cetak PDF" /><input type="submit" style="display:none;" name="excell" value="Export to Excell" /></td>
	</tr>
</table>
</form>
</body>
