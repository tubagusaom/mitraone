...
class CI_DB_sasql_driver extends CI_DB
{
	...
	var $dbdriver = 'sasql';
	// the character used to excape - not necessary for SYBASE
	var $_escape_char = '';
	...
	function db_connect()
	{
		return @sasql_connect("Uid=".$this->username.";Pwd=".$this->password.";ServerName=".$this->server_name.";CommLinks=tcpip(host=".$this->hostname.";port=".$this->port.")");
	}
	...
	{
		return @sasql_pconnect("Uid=".$this->username.";Pwd=".$this->password.";ServerName=".$this->server_name.";CommLinks=tcpip(host=".$this->hostname.";port=".$this->port.")");
	}
