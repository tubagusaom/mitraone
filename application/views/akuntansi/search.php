    ...
    <div class="x-panel-bwrap">
        <form id="myform">
            <table class="table-data">
                <tr>
                    <td style="width: 150px;">Kode Akun </td>
                    <td>
                        <input id="kode_akun" name="kode_akun" style="width: 200px;" class="easyui-textbox">
                    </td>
                </tr>
                <tr>
                    <td style="width: 150px;">Nama Akun</td>
                    <td>
                        <input id="nama_akun" name="nama_akun" style="width: 200px;" class="easyui-textbox" >
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <a id="btn" href="#" onclick="cetak_akun()" class="easyui-linkbutton" data-options="iconCls:'icon-print'">Cetak Akun</a>
                    </td>
                </tr>
