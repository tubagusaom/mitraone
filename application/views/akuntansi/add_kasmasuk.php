    ...
    <div class="x-panel-bwrap">
        <form id="myform" >
            <table class="table-data">
                        ...
                        <input type="hidden" id="kd" name="kd" value="AL1-1111" style="width: 280px;"  >
                        ...
                        <input type="hidden" id="tipe_jurnal" name="tipe_jurnal" value="JKM" style="width: 280px;"  > 
                ...
                <tr>
                    <td style="width: 150px;">Akun Debet Kas : </td>
                    <td>
                        AL1-1111
                    </td>
                </tr>
                ...
                <tr>
                    <td style="width: 150px;">Perolehan Dari (Akun Selain Kas) : </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="hidden" id="ket" name="ket" value="Pemasukan Kas" style="width: 280px;"  > 
