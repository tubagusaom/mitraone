...
<div class="container">
    ...
    <div class="col-md-10" style="padding-top: 15px;">
            <div class="col-md-8">
                <h2>Pengisian Formulir Online APL 01 dan 02 Uji Kompetensi</h2>
                <p>
                    Pada pengisian formulir uji kompetensi ada 4 tahapan yang harus di lewati antaran lain :
                    <ul>
                        <li>Memilih Skema Sertifikasi</li>
                        <li>Mengisi biodata diri</li>
                        <li>Tentukan dan upload bukti pendukung</li>
