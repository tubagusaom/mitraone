            <table class="table-data">
                ...
                <tr>
                    ...
                    <td>
                        <input id="tgl_lahir" name="tgl_lahir" style="width: 250px;" class="easyui-datebox" value="<?php echo date('d/m/Y', strtotime($data_siswa->tgl_lahir)) ?>" >
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input id="email" name="email" style="width: 250px;" class="easyui-textbox" value="<?php echo $data_siswa->email_siswa ; ?>" >
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <img width="100px" height="130px" id="foto" src="<?php echo base_url()."assets/img/siswa/".$data_siswa->foto; ?>">
                    </td>
